...
<div class="container-fluid  overflow-hidden">
        <div class="row flex-nowrap">
            <div class="col-auto col-md-3 col-xl-2 px-sm-2 position-fixed top-0 px-0 bg-dark  " style="height: 100vh;">
                ...
                <div class="d-flex flex-column justify-content-around align-items-center px-3 pt-2 text-white  ps-5 ">
                    <a href="Dashboard.php" class="pb-sm-3 mb-md-1 me-md-auto text-black text-decoration-none ">
                        ...
                        <img src="logoW.png" alt="logo-white" class="logo-navbar">
                    </a>
                    <div class="d-flex flex-column align-items-center ">
                        <img src="images/img.jpg" alt="hugenerd" width="70" height="70" class="rounded-circle  mt-1">
                    ...
                    <ul class="nav nav-pills flex-column  mb-sm-auto mb-0 align-items-center align-items-sm-start " id="menu">
                        <li class="nav-item mb-3  " style="font-size: 16px;">
                            <a href="#" class="btn  align-middle ">
                        ...
                        <li class="mt-3 ">
                            <a href="#" data-bs-toggle="collapse" class="btn  text-dark">
                                ...
                                <a class="ms-1 d-none d-sm-inline mt-2  text-white" style="font-size:10px;"> Se Déconnecter
                                </a>
                            </a>
                        </li>
                </div>
